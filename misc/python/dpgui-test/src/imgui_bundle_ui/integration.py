# Copy/pasted from https://raw.githubusercontent.com/pthom/imgui_bundle/main/bindings/imgui_bundle/demos_python/demos_immapp/imgui_example_glfw_opengl3.py
