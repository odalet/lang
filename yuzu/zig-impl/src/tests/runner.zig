// Adapted (with fixes applied) from https://gist.github.com/nurpax/4afcb6e4ef3f03f0d282f7c462005f12
// ----------------
...
//   .target = target,
//   .optimize = optimize,
//   .test_runner = b.path(".../runner.zig"), // add this line
...
const Printer = struct {
    ...
    fn status(self: Printer, s: Status, comptime format: []const u8, args: anytype) void {
        ...
        self.out.writeAll(color) catch @panic("writeAll failed?!");
        std.fmt.format(self.out, format, args) catch @panic("std.fmt.format failed?!");
        self.fmt("\x1b[0m", .{});
    }
};
